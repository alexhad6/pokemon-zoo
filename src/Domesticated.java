public abstract class Domesticated extends Pokemon {
	...
	public void tick() {
		...
		if (hunger > 25) {
			System.out.println(getName() + " is a little hungry.");
		}
		else if (hunger > 50) {
			System.out.println(getName() + " is getting hungry.");
		}
		else if (hunger > 75) {
			System.out.println(getName() + " is getting very hungry.");
		}
		else if (hunger > 100) {
			System.out.println(getName() + " fainted due to hunger!");
			System.out.println();
			System.out.println(getName() + " was rushed to the Pokecenter and is all better now! Please remember to feed your Pokemon!");
			hunger = 0;
		}
	}
